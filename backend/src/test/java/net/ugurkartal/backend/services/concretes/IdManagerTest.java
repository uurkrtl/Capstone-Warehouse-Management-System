...
class IdManagerTest {
    ...
    @Test
    void generateStockMovementIdReturnsUniqueId() {
        String id1 = idManager.generateStockMovementId();
        String id2 = idManager.generateStockMovementId();
    ...
    @Test
    void generateStockMovementIdReturnsIdWithCorrectPrefix() {
